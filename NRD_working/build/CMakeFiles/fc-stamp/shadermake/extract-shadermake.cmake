...
#
get_filename_component(filename "C:/Users/patry/Documents/NRD/build/_deps/shadermake-tmp/18f5a344e7ca8fa65daaf079d07bc8ce38453e05.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/patry/Documents/NRD/build/_deps/shadermake-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-shadermake${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-shadermake${i}")
